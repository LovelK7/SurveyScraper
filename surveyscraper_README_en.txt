...
3. Define the sign of the points (optional)
	For example according to the author of the survey (John Doe - "JD") or the name of the cave (Does's cave - "dc")
...
4. Include magnetic declination (optional). A separate calculation window opens.
	...
	4.7 Apply. The window will close, and the calculated magnetic declinations will be saved
...
The language of the program is changed by the dropdown setting at the top of the main window. The use of a new language is 
possible only by reopening the program.
